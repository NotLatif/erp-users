...
{#if actionSuccess}
	<div 
		class="fixed bottom-4 right-4 z-50 bg-green-500 text-white px-4 py-2 rounded shadow-lg"
...
{#if actionFailure}
	<div 
		class="fixed bottom-4 right-4 z-50 bg-red-500 text-white px-4 py-2 rounded shadow-lg"
		transition:fade={{ duration: 200 }}
	>
		{actionFailure}
	</div>
...
<div class="flex min-h-screen flex-col bg-gradient-to-br from-blue-50 to-indigo-100">
	<header class="flex items-center justify-between bg-white p-6 shadow">
		<h1 class="text-3xl font-bold text-indigo-700">ERP Users Dashboard</h1>
		<button
			class="rounded bg-indigo-600 px-4 py-2 text-white shadow transition hover:bg-indigo-700"
	...
	<main class="flex flex-1 flex-col gap-8 p-8">
		<section class="rounded-lg bg-white p-6 shadow">
			<h2 class="mb-4 text-xl font-semibold text-gray-700">User Management</h2>
					...
					<tbody class="divide-y divide-gray-200 bg-white">
						{#each users as user (user.id)}
							<tr transition:fade>
								...
								<td class="px-6 py-4 whitespace-nowrap">User</td> <!-- Placeholder for role, can be dynamic -->
		...
		<section class="pointer-events-none rounded-lg bg-white p-6 opacity-60 shadow">
			<h2 class="mb-4 text-xl font-semibold text-gray-700">[Placeholder] Products Management</h2>
			<p class="text-gray-400">Coming soon: Products Management.</p>
		</section>

		<section class="pointer-events-none rounded-lg bg-white p-6 opacity-60 shadow">
			<h2 class="mb-4 text-xl font-semibold text-gray-700">[Placeholder] Orders Management</h2>
			<p class="text-gray-400">Coming soon: Orders Management.</p>
		</section>
	</main>

	<footer class="mt-8 border-t bg-white py-4 text-center text-gray-400">
		By <a href="https://github.com/NotLatif?tab=repositories" class="text-indigo-600 underline"
			>NotLatif</a
		>
	</footer>
</div>
