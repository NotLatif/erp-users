<script lang="ts">
    ...
    const mockStockEntries: StockEntry[] = [
        ...
        { id: 4, quantity: 12, uat: '2025-07-01T09:20:00', product: mockProducts[3], warehouse: mockWarehouses[1] },
        { id: 3, quantity: 12, uat: '2025-07-01T09:20:00', product: mockProducts[3], warehouse: mockWarehouses[1] },
        { id: 6, quantity: 4, uat: '2025-07-02T10:30:00', product: mockProducts[0], warehouse: mockWarehouses[2] },
        { id: 5, quantity: 8, uat: '2025-07-01T16:05:00', product: mockProducts[4], warehouse: mockWarehouses[2] },
        { id: 6, quantity: 4, uat: '2025-07-02T10:30:00', product: mockProducts[0], warehouse: mockWarehouses[2] },
    ];
